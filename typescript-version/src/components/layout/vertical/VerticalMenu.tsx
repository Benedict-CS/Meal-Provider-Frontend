  ...
  return (
    <Menu menuItemStyles={menuItemStyles(verticalNavOptions, theme, settings)} menuSectionStyles={menuSectionStyles(verticalNavOptions, theme)} >
      {user && user.email === 'admin@gmail.com' ? (
        ...
        <MenuSection label="Apps & Pages">
          <MenuItem icon={<i className='tabler-dots' />} href={`/${locale}/apps/menu-management`}>Menu</MenuItem>
          <MenuItem icon={<i className='tabler-file' />} href={`/${locale}/apps/order-management`}>Order</MenuItem>
          <MenuItem icon={<i className='tabler-list' />} href={`/${locale}/apps/credit-management/list`}>Credit</MenuItem>
