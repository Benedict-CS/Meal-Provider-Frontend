...
// View Imports
import Calendar from '@views/apps/menu/Menu'
import SidebarLeft from '@views/apps/menu/SidebarLeft'
import AddEventSidebar from '@views/apps/menu/AddEventSidebar'
