...
```
cd existing_repo
git remote add origin https://gitlab.winfra.cs.nycu.edu.tw/112-cn/meal-provider-front-end.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.winfra.cs.nycu.edu.tw/112-cn/meal-provider-front-end/-/settings/integrations)
